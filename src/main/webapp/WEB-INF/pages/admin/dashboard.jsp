...
com.spra.model.UserModel currentUser = (com.spra.model.UserModel) session.getAttribute("loggedInUser");
%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<link rel="icon" type="image/svg+xml"
	href="<%=contextPath%>/assets/images/favicon.svg">
<link
...
<body class="admin-body">
		...
		<aside class="admin-sidebar">
			<div class="admin-sidebar-top">
				...
				<p class="admin-welcome">
					Hi,
					<%=currentUser != null ? currentUser.getFirstName() : "Admin"%>
					&middot; Admin Panel
				</p>
			</div>
			<nav class="admin-nav">
				...
				<a href="<%=contextPath%>/admin/dashboard"
					class="admin-nav-link <%=currentUri.endsWith("/dashboard") ? "active" : ""%>">
					<svg width="15" height="15" viewBox="0 0 24 24" fill="none"
						stroke="currentColor" stroke-width="1.8">
						<rect x="3" y="3" width="7" height="7" rx="1" />
						<rect x="14" y="3" width="7" height="7" rx="1" />
						<rect x="3" y="14" width="7" height="7" rx="1" />
						<rect x="14" y="14" width="7" height="7" rx="1" /></svg> <span
					class="nav-label">Dashboard</span>
				</a> <a href="<%=contextPath%>/admin/products" class="admin-nav-link">
					<svg width="15" height="15" viewBox="0 0 24 24" fill="none"
						stroke="currentColor" stroke-width="1.8">
						<path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z" />
						<line x1="3" y1="6" x2="21" y2="6" /></svg> <span class="nav-label">Products</span>
				</a> <a href="<%=contextPath%>/admin/orders" class="admin-nav-link">
					<svg width="15" height="15" viewBox="0 0 24 24" fill="none"
						stroke="currentColor" stroke-width="1.8">
						<path
							d="M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2" />
						<rect x="9" y="3" width="6" height="4" rx="1" />
						<path d="m9 12 2 2 4-4" /></svg> <span class="nav-label">Orders</span>
				</a> <a href="<%=contextPath%>/admin/messages" class="admin-nav-link">
					<svg width="15" height="15" viewBox="0 0 24 24" fill="none"
						stroke="currentColor" stroke-width="1.8">
						<path
							d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" />
						<polyline points="22,6 12,13 2,6" /></svg> <span class="nav-label">Messages</span>
				</a>
				<div class="admin-nav-section">Store</div>
				<a href="<%=contextPath%>/home" class="admin-nav-link"> <svg
						width="15" height="15" viewBox="0 0 24 24" fill="none"
						stroke="currentColor" stroke-width="1.8">
						<path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" /></svg> <span
					class="nav-label">View Site</span>
				</a>
			</nav>
		...
		<main class="admin-main">
			...
			<div class="admin-content">
				...
				<div class="admin-stats-grid">
					...
					</a> <a href="<%=contextPath%>/admin/orders" class="stat-card-link">
						<div class="admin-stat-card">
							<div class="admin-stat-icon">
								<svg width="16" height="16" viewBox="0 0 24 24" fill="none"
									stroke="currentColor" stroke-width="2">
					...
					</a> <a href="<%=contextPath%>/admin/products" class="stat-card-link">
						<div class="admin-stat-card">
							<div class="admin-stat-icon">
								<svg width="16" height="16" viewBox="0 0 24 24" fill="none"
									stroke="currentColor" stroke-width="2">
					...
					</a> <a href="<%=contextPath%>/admin/messages" class="stat-card-link">
						<div class="admin-stat-card">
							<div class="admin-stat-icon">
								<svg width="16" height="16" viewBox="0 0 24 24" fill="none"
									stroke="currentColor" stroke-width="2">
				...
				<div class="dashboard-two-col">
					...
					<div class="admin-section">
						<div class="admin-section-head">
							<span class="admin-section-title">Recent Orders</span> <a
								href="<%=contextPath%>/admin/orders" class="admin-view-all">View
								All →</a>
						</div>
						<c:choose>
							...
							<c:otherwise>
								<c:forEach var="order" items="${recentOrders}" begin="0" end="4">
									<div class="dash-order-row" title="Click to view order items"
					...
					<div class="admin-section">
						<div class="admin-section-head">
							<span class="admin-section-title">Recent Messages</span> <a
								href="<%=contextPath%>/admin/messages" class="admin-view-all">View
								All →</a>
						</div>
						<c:choose>
							...
							<c:otherwise>
								<div class="msg-preview-list">
									<c:forEach var="msg" items="${recentMessages}" begin="0"
										end="4">
										<div class="msg-preview-card"
											...
											<div class="mpc-body">
												<div class="mpc-top">
													<span class="mpc-name">${msg.fullName}</span> <span
														class="mpc-date">${msg.createdAt}</span>
												</div>
	...
	<div id="orderDetailOverlay"
		...
		<div id="orderDetailBox"
			style="background: #fff; border-radius: 22px; width: 600px; max-width: 95vw; max-height: 88vh; overflow-y: auto; box-shadow: 0 40px 100px rgba(0, 0, 0, .28); animation: odSlide .38s cubic-bezier(.22, 1, .36, 1); position: relative; font-family: 'DM Sans', sans-serif;">
			...
			<div id="odLoading"
				...
				<div
					style="font-family: 'Cormorant Garamond', serif; font-size: 1.2rem; font-style: italic;">Loading…</div>
			</div>
			...
			<div id="odEmpty"
				...
				<div style="font-size: .75rem; margin-top: 6px;">Items are
					saved for orders placed after the system update.</div>
			</div>
