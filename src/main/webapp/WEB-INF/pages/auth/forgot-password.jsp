	...
	<div class="auth-container">
		...
		<div class="auth-panel">
			<div class="auth-panel-content">
				...
				<p class="auth-panel-sub">
					We'll send a secure link<br />straight to your inbox.
				</p>
			</div>
		</div>
		...
		<div class="auth-form-panel">
			<div class="auth-form-wrap">
				...
				<p class="auth-form-sub">Enter your account email and we'll send
					you a reset link.</p>
				...
				<c:if test="${empty successMessage}">
					<form method="post"
						...
						<button type="submit" class="auth-submit-btn">Send Reset
							Link</button>
					</form>
				</c:if>

				<p class="auth-back" style="margin-top: 1.5rem;">
					<a href="${pageContext.request.contextPath}/login">← Back to
						Sign In</a>
				</p>
