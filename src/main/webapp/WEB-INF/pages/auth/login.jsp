...
<head>
    ...
    <style>
        ...
        .auth-google-btn:hover {
            border-color: #e8536a;
            box-shadow: 0 2px 10px rgba(232,83,106,.12);
            background: #fdf8f8;
        }
        .auth-google-icon {
            width: 20px;
...
<div class="auth-container">
    ...
    <div class="auth-panel">
        <div class="auth-panel-content">
            ...
            <div class="auth-panel-title">Welcome<br/><em>back.</em></div>
            <p class="auth-panel-sub">Your beauty ritual<br/>is waiting for you.</p>
        </div>
    </div>
    ...
    <div class="auth-form-panel">
        <div class="auth-form-wrap">
            ...
            <p class="auth-form-sub">
                ...
                <a class="auth-link" href="${pageContext.request.contextPath}/register">Create one</a>
            </p>
            ...
            <a href="${pageContext.request.contextPath}/auth/google" class="auth-google-btn">
            ...
            <form method="post" action="${pageContext.request.contextPath}/login">
                ...
                <div class="form-group">
                    ...
                    <input class="form-input" type="text" id="username" name="username"
                           value="${username}" placeholder="your_username" autocomplete="username" required/>
                </div>
