...
<head>
    ...
    <title>Something Went Wrong — Spra.</title>
...
<div class="error-page">
    ...
    <h1 class="error-title">Something Went <em>Wrong</em></h1>
    <div class="error-divider"></div>
    <p class="error-sub">
        We're sorry — something unexpected happened on our end.
        Our team has been notified. Please try again in a moment.
    </p>

    <div class="error-actions">
        <a href="<%= contextPath %>/home" class="error-btn-primary">Go to Home</a>
        <a href="<%= contextPath %>/contact" class="error-btn-outline">Contact Support</a>
    </div>

    <p class="error-note">If the problem persists, please reach out to us at hello@spra.com</p>
</div>
</body>
</html>